...
- 为了使BBT能够更好的理解中文金融领域的文本，我们爬取了海量公开数据，收集整理了百G规模的公司公告，研究报告，财经新闻与网络论坛数据，形成了中文金融语料库BBT Corpus
- 在BBT Corpus上预训练出的BBT-Base，相对于普通文本上训练出来的T5，在金融评测任务上取得了显著提升。
